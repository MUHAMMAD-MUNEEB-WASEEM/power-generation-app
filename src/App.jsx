    ...
    <div className="App">
      ...
      <Router>
        <Routes>
          ...
          {/*this should be with improvement*/}
          <Route path='/loadprofiles/loadprofile6' element={<LoadProfile image={image1} loadProfileData={[6412, 6074, 5939, 5837, 6067, 6809, 8145, 8983, 9238, 9246, 9454, 9530, 9320, 9329, 9261, 9182, 8973, 9001, 8774, 8396, 8142, 7913, 7506, 6868]} capitalFactor={1000}  interest_p={0} fuel_p={1.36} consumption={0.3} remarks="Poor" button="View Recommendation"/>}></Route>
        
          {/*Recommendation*/}
          <Route path='/loadprofiles/loadprofile6/recommendation' element={<Recommendation/>}/>
